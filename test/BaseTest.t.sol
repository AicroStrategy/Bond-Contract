...
contract BaseTest is Test {
    ...
    function setUp() public virtual {
        ...
        bytes memory constructorArgs =
            abi.encode(ASSET_NAME, ASSET_SYMBOL, ASSET_DECIMALS, ASSET_SUPPLY, address(factory));
        ...
        assetToken =
            new MintableERC20{salt: salt}(ASSET_NAME, ASSET_SYMBOL, ASSET_DECIMALS, ASSET_SUPPLY, address(factory));
