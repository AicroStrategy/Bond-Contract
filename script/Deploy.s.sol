...
contract DeployFactoryAndMintableERC20 is Script {
    ...
    function run() public {
        ...
        bytes memory constructorArgs = abi.encode(name, symbol, decimals, initialSupply, address(this));
        ...
        address token = address(new MintableERC20{salt: salt}(name, symbol, decimals, initialSupply, address(this)));
